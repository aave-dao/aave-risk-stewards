...
mainnet-contract:; FOUNDRY_PROFILE=mainnet forge script ${contract_path} --rpc-url mainnet --block-timestamp 1717019296 --sig "run(bool)" false -vv
...
arbitrum-contract:; FOUNDRY_PROFILE=arbitrum forge script ${contract_path} --rpc-url arbitrum --block-timestamp 1717102380 --sig "run(bool)" false -vv
